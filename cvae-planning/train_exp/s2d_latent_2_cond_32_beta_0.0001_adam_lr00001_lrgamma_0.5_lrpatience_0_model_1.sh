...
--e_net_input_size 32 --e_net_output_size 28 --input_size 2 --latent_size 2 --cond_size 32 --beta 0.0001 \
--model_id 1 --learning_rate 0.00001 --lr_schedule_gamma 0.5 --lr_schedule_patience 0 \
--device 1 --num_epochs 100 --batch_size 256 \
